...
/***/ function(module, exports, __webpack_require__) {
	...
	var _column = __webpack_require__(160);
	...
	var Root = function (_React$Component) {
	    ...
	    _createClass(Root, [{
	        ...
	        value: function render() {
	            var self = this;
	            var state = self.state || self.props;
	            var boards = state.boards.map(function (board) {
	                var issues = state.issues.filter(function (issue) {
	                    var keyword = issue.keywords.filter(function (current, index, array) {
	                        return current.keyword == "column";
	                ...
	                return _react2.default.createElement(
	                    'div',
	                    { key: "board-" + board.name, className: 'col-md-3' },
	        ...
	        value: function componentDidMount() {
	            ...
	            var self = this;
	            window.fetch('/problems/open').then(function (response) {
	                return response.json();
	            }).then(function (issues) {
	                return issues.map(function (issue) {
	                    return self.props.store.dispatch((0, _actions.addIssue)(issue));
	                });
	            });

	            self.props.store.subscribe(function () {
	                _this2.setState(self.props.store.getState());
	            });
	        }
	    }]);
	...
	Root.defaultProps = Object.assign({}, { store: _store.store }, _store.store.getState());

	_reactDom2.default.render(_react2.default.createElement(Root, null), document.getElementById('mountNode'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reactDragula = __webpack_require__(161);
	    ...
	    _createClass(Column, [{
	        ...
	        value: function render() {
	            ...
	            var issues = this.props.issues.map(function (issue) {
	                return _react2.default.createElement(
	                    'li',
	                    { key: "wrapper-issue" + issue.identifier },
	                    _react2.default.createElement(_card2.default, { store: self.props.store, drake: self.props.drake, issue: issue })
	                );
	            });
	            return _react2.default.createElement(
	                'div',
	                ...
	                _react2.default.createElement(
	                    'ul',
	                    { id: "list-" + self.props.name, className: 'panel-body list-unstyled' },
	                    issues
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var dragula = __webpack_require__(162);
	var atoa = __webpack_require__(164);
	...
	var Card = function (_React$Component) {
	    ...
	    _createClass(Card, [{
	        ...
	        value: function render() {
	            ...
	            var component = milestone.component || {};
	            return _react2.default.createElement(
	                'div',
	                { id: "issue-" + issue.identifier, className: 'panel panel-default' },
	                _react2.default.createElement(
	                    'div',
	                    ...
	                    _react2.default.createElement(
	                        'a',
	                        { className: 'pull-right', href: "ship://Problems/" + issue.identifier },
	                        issue.identifier
	                    )
	                ),
	                _react2.default.createElement(
	        ...
	        value: function componentDidMount() {
	            ...
	            self.props.drake.on('drop', function (el, target, source, sibling) {
	                var key = +el.children[0].id.split('-')[1];
	                var dest_column = target.id.split('-')[1];
	                var source_column = source.id.split('-')[1];
	                ...
	                if (self.props.issue.identifier === key) {
	                    window.fetch('/problems/' + key + '/move/' + dest_column, {
	                        ...
	                        if (response.status >= 200 && response.status < 300) {
	                            self.props.store.dispatch((0, _actions.moveIssue)(key, dest_column));
	                        } else {
	                            self.props.store.dispatch({ type: _actions.NOOP });
	                        }
	                    }).then();
	                }
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var initialState = {
	    ...
	    boards: [{ name: "Triage" }, { name: "Todo" }, { name: "Doing" }, { name: "Done" }],
	    issues: []
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	function addIssueAction(state, new_issue) {
	    if ((0, _util.or)(state.map(function (issue) {
	        return issue.identifier === new_issue.identifier;
	    }))) {
	        return state;
	    } else {
	...
	function issues() {
	    ...
	    switch (action.type) {
	        case _actions.MOVE_ISSUE:
	            return state.map(function (issue) {
	...
	var kanbanApp = (0, _redux.combineReducers)({
	    issues: issues,
	    drake: drake,
	    boards: boards
	});
...
/***/ function(module, exports) {
	...
	var MOVE_ISSUE = exports.MOVE_ISSUE = 'MOVE_ISSUE';
	var ADD_ISSUE = exports.ADD_ISSUE = 'ADD_ISSUE';
	var NOOP = exports.NOOP = 'NOOP';

	function moveIssue(id, column) {
